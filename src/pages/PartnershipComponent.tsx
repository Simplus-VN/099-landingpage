...
const PartnershipComponent: React.FC = () => {
  ...
  return <div>
    <div className='text-center lg:pt-16 lg:pb-10 py-8'>
      ...
      <Image src="/img/Background.png" preview={false} alt='banner' className='lg:mt-12 mt-8 rounded-corner-04'/>
    </div>

    <div className='flex md:gap-8 items-center lg:pt-10 pt-8 md:flex-row flex-col gap-6'>
      <div className='flex-1 flex-shink-0'>
        <h4 className='lg:text-[40px] lg:leading-[52px] text-[32px] leading-10 font-semibold text-primary'>Lorem ipsum</h4>
      ...
      <div className='flex-1 flex-shink-0'>
        <Image src="/img/Background.png" preview={false} alt='banner'
    ...
    <div className='pt-16 relative '>
      <Image src="/img/register-collab-bg.png" preview={false} alt='banner'
             className='rounded-corner-04 w-full hidden md:block '/>
      <Image src="/img/register-collab-bg-mb.png" preview={false} alt='banner'
      ...
      <div className='absolute md:top-[calc(128/368*100%)] top-[calc(64/376*100%)] sm:top-[20%] text-center w-full px-4 md:px-8'>
        <p className='xl:text-[40px] xl:leading-[52px] md:text-3xl font-semibold text-[36px] leading-[44px]'>Cộng tác với Simplus ngay hôm nay!</p>
        <p className='xl:mt-4 md:mt-2 text-primary xl:text-lg font-medium mt-4 text-lg'>Liên hệ SimPlus để trở thành cộng tác viên kinh doanh các sản phẩm/ dịch vụ viễn thông</p>
        <Button onClick={() => setIsOpenModalRegisterCollab(true)} className='mx-auto xl:mt-8 mt-8 sm:mt-0 h-12 w-full lg:mt-4 !text-primary !bg-white rounded-corner-03 border-none xl:h-14 xl:text-2xl xl:px-5 xl:py-3 flex items-center justify-center sm:w-fit text-xl sm:text-base py-3 sm:h-fit sm:py-2'>Đăng ký ngay</Button>
      </div>
    </div>
